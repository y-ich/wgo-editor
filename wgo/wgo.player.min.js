...
a;this.node=this.kifu.root;this.allow_illegal=c||!1;this.game=new d.Game(this.kifu.size,this.allow_illegal?"NONE":"KO",this.allow_illegal,this.allow_illegal);this.path={m:0};this.kifu.info.HA&&1<this.kifu.info.HA&&(this.game.turn=d.W);this.change=w(this.game,this.node,!0);this.rememberPath=b?!0:!1},z=function(a,b){var c=[],e,g;for(g in a){e=!0;for(var d in b)if(a[g].x==b[d].x&&a[g].y==b[d].y){e=!1;break}e&&c.push(a[g])}return c},w=function(a,b,c){b.parent&&(b.parent._last_selected=b.parent.children.indexOf(b));
if(b.move!=h){if(b.move.pass)return a.pass(b.move.c),{add:[],remove:[]};a=a.play(b.move.x,b.move.y,b.move.c);if("number"==typeof a)throw new x(a,b);for(var e in a)if(a[e].x==b.move.x&&a[e].y==b.move.y)return{add:[],remove:a};return{add:[b.move],remove:a}}c||a.pushPosition();c=[];var g=[];if(b.setup!=h)for(e in b.setup)b.setup[e].c?(a.setStone(b.setup[e].x,b.setup[e].y,b.setup[e].c),c.push(b.setup[e])):(a.removeStone(b.setup[e].x,b.setup[e].y),g.push(b.setup[e]));b.turn&&(a.turn=b.turn);return{add:c,
remove:g}},y=function(a){a===h&&this.rememberPath&&(a=this.node._last_selected);a=a||0;var b=this.node.children[a];if(!b)return!1;var c=w(this.game,b);this.path.m++;1<this.node.children.length&&(this.path[this.path.m]=a);this.node=b;return c},A=function(){if(!this.node.parent)return!1;this.node=this.node.parent;this.game.popPosition();this.node.turn&&(this.game.turn=this.node.turn);this.path[this.path.m]!==h&&delete this.path[this.path.m];this.path.m--;return!0},B=function(){this.game.firstPosition();
this.node=this.kifu.root;this.path={m:0};this.kifu.info.HA&&1<this.kifu.info.HA&&(this.game.turn=d.W);this.change=w(this.game,this.node,!0)};b.prototype={constructor:b,next:function(a){this.change=y.call(this,a);return this},last:function(){var a;for(this.change={add:[],remove:[]};a=y.call(this);){var b=this.change;b.add=z(b.add,a.remove).concat(a.add);b.remove=z(b.remove,a.add).concat(a.remove)}return this},previous:function(){var a=this.game.getPosition();A.call(this);this.change=v(a,this.game.getPosition());
return this},first:function(){var a=this.game.getPosition();B.call(this);this.change=v(a,this.game.getPosition());return this},goTo:function(a){if(a===h)return this;var b=this.game.getPosition();B.call(this);for(var c=0;c<a.m&&y.call(this,a[c+1]);c++);this.change=v(b,this.game.getPosition());return this},previousFork:function(){for(var a=this.game.getPosition();A.call(this)&&1==this.node.children.length;);this.change=v(a,this.game.getPosition());return this},getPosition:function(){return this.game.getPosition()},
allowIllegalMoves:function(a){a?(this.game.allow_rewrite=!0,this.game.allow_suicide=!0,this.repeating="NONE"):(this.game.allow_rewrite=!1,this.game.allow_suicide=!1,this.repeating="KO")}};d.KifuReader=b;var x=function(a,b){this.name="InvalidMoveError";this.message="Invalid move in kifu detected. ";if(b.move&&b.move.c!==h&&b.move.x!==h&&b.move.y!==h){var c=b.move.x;7<b.move.x&&c++;String.fromCharCode(c+65);this.message+="Trying to play "+(b.move.c==d.WHITE?"white":"black")+" move on "+String.fromCharCode(b.move.x+
65)+""+(19-b.move.y)}else this.message+="Move object doesn't contain arbitrary attributes.";if(a)switch(a){case 1:this.message+=", but these coordinates are not on board.";break;case 2:this.message+=", but there already is a stone.";break;case 3:this.message+=", but this move is a suicide.";break;case 4:this.message+=", but this position already occured."}else this.message+="."};x.prototype=Error();x.prototype.constructor=x;d.InvalidMoveError=x;d.i18n.en.show="show";d.i18n.en["res-show-tip"]="Click to show result."})(WGo);(function(d,h){d.SGF={};var l=function(c,e,d,b,a,f){e=f==e?"black":"white";d.info[e]=d.info[e]||{};d.info[e][c]=a[0]},f=d.SGF.properties={};f.B=f.W=function(c,e,f,b){e.move=!f[0]||19>=c.size&&"tt"==f[0]?{pass:!0,c:"B"==b?d.B:d.W}:{x:f[0].charCodeAt(0)-97,y:f[0].charCodeAt(1)-97,c:"B"==b?d.B:d.W}};f.AB=f.AW=function(c,e,f,b){for(var a in f)e.addSetup({x:f[a].charCodeAt(0)-97,y:f[a].charCodeAt(1)-97,c:"AB"==b?d.B:d.W})};f.AE=function(c,e,d){for(var b in d)e.addSetup({x:d[b].charCodeAt(0)-97,y:d[b].charCodeAt(1)-
...
"Caps";WGo.i18n.en.time="Time";WGo.BasicPlayer.component.InfoBox=k})(WGo);(function(d,h){var l=function(c){var e,d;e=c.charCodeAt(0)-97;0>e&&(e+=32);7<e&&e--;d=c.charCodeAt(1)-48;2<c.length&&(d=10*d+(c.charCodeAt(2)-48));d=this.kifuReader.game.size-d;this._tmp_mark={type:"MA",x:e,y:d};this.board.addObject(this._tmp_mark)},f=function(){this.board.removeObject(this._tmp_mark);delete this._tmp_mark},p=function(c,d){for(var e in c)c[e].className&&"wgo-move-link"==c[e].className?(c[e].addEventListener("mouseover",l.bind(d,c[e].innerHTML)),c[e].addEventListener("mouseout",f.bind(d))):
...
a.value="0";a.maxlength=3;a.className="wgo-player-mn-value";this.element.appendChild(a);this.element.onsubmit=a.onchange=function(a){a.goTo(this.getValue());return!1}.bind(this,b);b.addEventListener("update",function(a){this.setValue(a.path.m)}.bind(this));b.addEventListener("kifuLoaded",this.enable.bind(this));b.addEventListener("frozen",this.disable.bind(this));b.addEventListener("unfrozen",this.enable.bind(this))});f.MoveNumber.prototype.disable=function(){f.MoveNumber.prototype["super"].prototype.disable.call(this);
this.move.disabled="disabled"};f.MoveNumber.prototype.enable=function(){f.MoveNumber.prototype["super"].prototype.enable.call(this);this.move.disabled=""};f.MoveNumber.prototype.setValue=function(b){this.move.value=b};f.MoveNumber.prototype.getValue=function(){return parseInt(this.move.value)};var q=function(b){if(b._menu_tmp)delete b._menu_tmp;else{if(!b.menu){b.menu=document.createElement("div");b.menu.className="wgo-player-menu";b.menu.style.position="absolute";b.menu.style.display="none";this.element.parentElement.appendChild(b.menu);
var a,c;for(c in l.menu)a=new l.menu[c].constructor(b,l.menu[c].args,!0),a.appendTo(b.menu)}if("none"!=b.menu.style.display)return b.menu.style.display="none",document.removeEventListener("click",b._menu_ev),delete b._menu_ev,this.unselect(),!1;b.menu.style.display="block";a=this.element.offsetTop;c=this.element.offsetLeft;this.element.parentElement.parentElement.parentElement.parentElement==b.regions.bottom.wrapper?(b.menu.style.left=c+"px",b.menu.style.top=a-b.menu.offsetHeight+1+"px"):(b.menu.style.left=
c+"px",b.menu.style.top=a+this.element.offsetHeight+"px");b._menu_ev=q.bind(this,b);b._menu_tmp=!0;document.addEventListener("click",b._menu_ev);return!0}};l.menu=[{constructor:f.MenuItem,args:{name:"switch-coo",togglable:!0,click:function(b){b.setCoordinates(!b.coordinates);return b.coordinates},init:function(b){b.coordinates&&this.select()}}}];l.widgets=[{constructor:f.Group,args:{name:"left",widgets:[{constructor:f.Button,args:{name:"menu",togglable:!0,click:q}}]}},{constructor:f.Group,args:{name:"right",
widgets:[{constructor:f.Button,args:{name:"move-number",click:function(b){b.config.displayMoveNumbers=!b.config.displayMoveNumbers;b.goTo(b.kifuReader.path)}}}]}},{constructor:f.Group,args:{name:"control",widgets:[{constructor:f.Button,args:{name:"first",disabled:!0,init:function(b){b.addEventListener("update",p.bind(this));b.addEventListener("frozen",c.bind(this));b.addEventListener("unfrozen",e.bind(this))},click:function(b){b.first()}}},{constructor:f.Button,args:{name:"multiprev",disabled:!0,
multiple:!0,init:function(b){b.addEventListener("update",p.bind(this));b.addEventListener("frozen",c.bind(this));b.addEventListener("unfrozen",e.bind(this))},click:function(b){var a=d.clone(b.kifuReader.path);a.m-=10;b.goTo(a)}}},{constructor:f.Button,args:{name:"previous",disabled:!0,multiple:!0,init:function(b){b.addEventListener("update",p.bind(this));b.addEventListener("frozen",c.bind(this));b.addEventListener("unfrozen",e.bind(this))},click:function(b){b.previous()}}},{constructor:f.MoveNumber},
{constructor:f.Button,args:{name:"next",disabled:!0,multiple:!0,init:function(b){b.addEventListener("update",k.bind(this));b.addEventListener("frozen",c.bind(this));b.addEventListener("unfrozen",e.bind(this))},click:function(b){b.next()}}},{constructor:f.Button,args:{name:"multinext",disabled:!0,multiple:!0,init:function(b){b.addEventListener("update",k.bind(this));b.addEventListener("frozen",c.bind(this));b.addEventListener("unfrozen",e.bind(this))},click:function(b){var a=d.clone(b.kifuReader.path);
a.m+=10;b.goTo(a)}}},{constructor:f.Button,args:{name:"last",disabled:!0,init:function(b){b.addEventListener("update",k.bind(this));b.addEventListener("frozen",c.bind(this));b.addEventListener("unfrozen",e.bind(this))},click:function(b){b.last()}}}]}}];var g=d.BasicPlayer.layouts;g.right_top.top.push("Control");g.right.right.push("Control");g.one_column.top.push("Control");g.no_comment.bottom.push("Control");g.minimal.bottom.push("Control");var g={about:"About",first:"First",multiprev:"10 moves back",
previous:"Previous",next:"Next",multinext:"10 moves forward",last:"Last","switch-coo":"Display coordinates",menu:"Menu","move-number":"Toggle move numbers"},r;for(r in g)d.i18n.en[r]=g[r];d.BasicPlayer.component.Control=l})(WGo);(function(d){var h=function(d,h){this.player.frozen||this._lastX==d&&this._lastY==h||(this._lastX=d,this._lastY=h,this._last_mark&&this.board.removeObject(this._last_mark),-1!=d&&-1!=h&&this.player.kifuReader.game.isValid(d,h)?(this._last_mark={type:"outline",x:d,y:h,c:this.player.kifuReader.game.turn},this.board.addObject(this._last_mark)):delete this._last_mark)},l=function(){this._last_mark&&(this.board.removeObject(this._last_mark),delete this._last_mark,delete this._lastX,delete this._lastY)};
...
y:h,c:this.player.kifuReader.game.turn},_edited:!0})),this.player.kifu._edited=!0,this.player.next(this.player.kifuReader.node.children.length-1);else{var k=this.player.kifuReader.node;0===k.children.length&&k.move.x===f&&k.move.y===h&&(this.player.previous(),k.remove())}};d.i18n.en.editmode="Edit mode"})(WGo);(function(d){d.BasicPlayer&&d.BasicPlayer.component.Control&&d.BasicPlayer.component.Control.menu.push({constructor:d.BasicPlayer.control.MenuItem,args:{name:"insert-frame",click:function(h){if(h.kifuReader.node.FG){var l=h.kifuReader.node;h.previous();l.remove()}else h.kifuReader.node.insertAfter(new d.KNode({FG:"",MN:"1"})),h.next();h.kifu._edited=!0}}});d.i18n.en["insert-frame"]="Insert or remove frame"})(WGo);
